package com.expenses.manager.di

import android.content.Context
import androidx.room.Room
import com.expenses.manager.BuildConfig
import com.expenses.manager.data.data_sources.local.AppDatabase
...
import com.expenses.manager.data.data_sources.remote.RemoteExchangeRatesDataSource
import com.expenses.manager.data.data_sources.remote.RemoteSymbolsDataSource
import com.expenses.manager.data.preferences.AppPreferences
import com.expenses.manager.data.preferences.AppPreferencesImpl
import com.expenses.manager.domain.exchange_rates.ExchangeRatesRepository
import com.expenses.manager.domain.exchange_rates.ExchangeRatesRepositoryImpl
import com.expenses.manager.domain.settings.SettingsRepository
import com.expenses.manager.domain.settings.SettingsRepositoryImpl
import com.expenses.manager.domain.statistics.StatisticsRepository
import com.expenses.manager.domain.statistics.StatisticsRepositoryImpl
import com.expenses.manager.domain.symbols.SymbolsRepository
import com.expenses.manager.domain.symbols.SymbolsRepositoryImpl
import com.expenses.manager.data.services.currency_converter.CurrenciesConverterService
import com.expenses.manager.data.services.currency_converter.CurrenciesConverterServiceImpl
import com.expenses.manager.data.services.expenses_statistics.ExpensesStatisticsService
import com.expenses.manager.data.services.expenses_statistics.ExpensesStatisticsServiceImpl
import dagger.Binds
